...
(function () {
    ...
    fluid.defaults("gpii.tests.oauth2.authorizationService.codeGenerator", {
            ...
            authorizationService: {
                ...
                options: {
                    ...
                    components: {
                        ...
                        codeGenerator: {
                            type: "gpii.tests.oauth2.authorizationService.codeGenerator"
                        }
                    }
                }
            },
    ...
    fluid.defaults("gpii.tests.oauth2.authorizationService.emptyDataStore", {
        ...
        rawModules: [{
            name: "Test authorizationService APIs with an empty dataStore",
            tests: [{
    ...
    fluid.defaults("gpii.tests.oauth2.authorizationService.withData.grantWebPrefsConsumerAuthCode", {
        gradeNames: ["gpii.tests.oauth2.authorizationService.testEnvironment"],
        pouchData: gpii.tests.oauth2.authorizationService.testData,
        rawModules: [{
            name: "Test gpii.oauth2.authorizationService.grantWebPrefsConsumerAuthCode()",
            tests: [{
                name: "grantWebPrefsConsumerAuthCode() sets expired for expired access tokens and returns unexpired access token",
                sequence: [{
                    func: "gpii.tests.oauth2.invokePromiseProducer",
                    args: ["{authorizationService}.grantWebPrefsConsumerAuthCode", ["alice_gpii_token", "client-1", "http://example.com/callback_A", {"": true}], "{that}"]
                }, {
                    listener: "jqUnit.assertDeepEq",
                    args: ["A new auth code should be returned", gpii.tests.oauth2.authorizationService.expected.grantWebPrefsConsumerAuthCode, "{arguments}.0"],
                    event: "{that}.events.onResponse"
                }]
            // }, {
            //     name: "grantWebPrefsConsumerAuthCode() returns undefined for nonexistent record",
            //     sequence: [{
            //         func: "gpii.tests.oauth2.invokePromiseProducer",
            //         args: [gpii.oauth2.authorizationService.findValidGpiiAppInstallationAuthorization, ["{authorizationService}.dataStore", "nonexistent-token", "nonexistent-client"], "{that}"]
            //     }, {
