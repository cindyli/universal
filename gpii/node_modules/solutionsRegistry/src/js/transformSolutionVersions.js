    ...
    fluid.each(solutionsTogo, function (solutionDef, solutionKey) {
        fluid.each(fluid.get(solutionDef, "settingsHandlers"), function (settingsHandlerDef, settingsHandlerId) {
            ...
            fluid.each(supportedSettings, function (settingDef, settingName) {
                if (settingDef.path) {
                    // 1. Handle the solution registry in verion 1
                    // 1.1 Add "path" element to "capabilitiesTransformations" block
                    ...
                    // 1.2. Add the validation block for the "path" element in "supportedSettings.{settingName}.schema.properties"
                    fluid.set(solutionsTogo,
                        [solutionKey,
                        "settingsHandlers",
                        settingsHandlerId,
                    ...
                    // 2. Remove the "path" element from the solution registry in versoin 2
