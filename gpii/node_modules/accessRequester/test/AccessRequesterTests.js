...
fluid.defaults("gpii.tests.accessRequesterTests", {
    ...
    publicClientCredentialFilePath: null,    // supplied by individual tests
    testCaseHolderGrade: null,   // supplied by individual tests
    distributeOptions: {
        publicClientCredentialFilePath: {
            source: "{that}.options.publicClientCredentialFilePath",
            target: "{that publicClientCredentialDataSource}.options.path"
        },
        testCaseHolderGrade: {
...
gpii.tests.accessRequester.success = {
    publicClientCredentialFilePath: "%gpii-universal/gpii/node_modules/accessRequester/test/data/clientCredential-correct.json",
    nockConfig: {
        request: {
            "grant_type": "password",
            "password": "dummy",
...
fluid.defaults("gpii.tests.accessRequesterTests.success", {
    ...
    publicClientCredentialFilePath: gpii.tests.accessRequester.success.publicClientCredentialFilePath,
...
gpii.tests.accessRequester.error_wrongClientCredential = {
    publicClientCredentialFilePath: "%gpii-universal/gpii/node_modules/accessRequester/test/data/clientCredential-wrong.json",
    nockConfig: {
...
fluid.defaults("gpii.tests.accessRequesterTests.error.wrongClientCredential", {
    gradeNames: ["gpii.tests.accessRequesterTests", "gpii.test.testWithNock"],
    publicClientCredentialFilePath: gpii.tests.accessRequester.error_wrongClientCredential.publicClientCredentialFilePath,
...
gpii.tests.accessRequester.error_missingClientCredentialFile = {
    publicClientCredentialFilePath: "non-existing.json",
    expected: {
        statusCode: 404,
        isError: true
    }
...
fluid.defaults("gpii.tests.accessRequesterTests.error.missingClientCredentialFile", {
    ...
    publicClientCredentialFilePath: gpii.tests.accessRequester.error_missingClientCredentialFile.publicClientCredentialFilePath,
