...
fluid.defaults("gpii.tests.accessRequesterTests", {
    ...
    localClientCredentialFilePath: null,    // supplied by individual tests
    testCaseHolderGrade: null,   // supplied by individual tests
    distributeOptions: {
        localClientCredentialFilePath: {
            source: "{that}.options.localClientCredentialFilePath",
            target: "{that localClientCredentialDataSource}.options.path"
        },
        testCaseHolderGrade: {
...
gpii.tests.accessRequester.success = {
    localClientCredentialFilePath: "%gpii-universal/gpii/node_modules/accessRequester/test/data/clientCredential-correct.json",
    nockConfig: {
        request: {
            "grant_type": "password",
            "password": "dummy",
...
fluid.defaults("gpii.tests.accessRequesterTests.success", {
    ...
    localClientCredentialFilePath: gpii.tests.accessRequester.success.localClientCredentialFilePath,
...
gpii.tests.accessRequester.error_wrongClientCredential = {
    localClientCredentialFilePath: "%gpii-universal/gpii/node_modules/accessRequester/test/data/clientCredential-wrong.json",
    nockConfig: {
...
fluid.defaults("gpii.tests.accessRequesterTests.error.wrongClientCredential", {
    gradeNames: ["gpii.tests.accessRequesterTests", "gpii.test.testWithNock"],
    localClientCredentialFilePath: gpii.tests.accessRequester.error_wrongClientCredential.localClientCredentialFilePath,
...
gpii.tests.accessRequester.error_missingClientCredentialFile = {
    localClientCredentialFilePath: "non-existing.json",
    expected: {
        statusCode: 404,
        isError: true
    }
...
fluid.defaults("gpii.tests.accessRequesterTests.error.missingClientCredentialFile", {
    ...
    localClientCredentialFilePath: gpii.tests.accessRequester.error_missingClientCredentialFile.localClientCredentialFilePath,
