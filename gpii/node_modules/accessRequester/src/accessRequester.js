...
fluid.defaults("gpii.accessRequester", {
    ...
    invokers: {
        getAccessToken: {
            ...
            args: ["{that}.localClientCredentialDataSource", "{that}.accessTokenDataSource", "{arguments}.0"]
                                                                                        // gpiiKey
        }
    }
});

gpii.accessRequester.getAccessToken = function (localClientCredentialDataSource, accessTokenDataSource, gpiiKey) {
    var promiseTogo = fluid.promise();
    var clientCredentialPromise = localClientCredentialDataSource.get();
