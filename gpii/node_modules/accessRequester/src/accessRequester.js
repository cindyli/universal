...
fluid.defaults("gpii.accessRequester", {
    ...
    components: {
        publicClientCredentialDataSource: {
            type: "gpii.accessRequester.clientCredentialDataSource.file"
        },
        privateClientCredentialDataSource: {
    ...
    invokers: {
        getAccessToken: {
            ...
            args: ["{that}.publicClientCredentialDataSource", "{that}.accessTokenDataSource", "{arguments}.0"]
                                                                                        // gpiiKey
        }
    }
});

gpii.accessRequester.getAccessToken = function (publicClientCredentialDataSource, accessTokenDataSource, gpiiKey) {
    var promiseTogo = fluid.promise();
    var clientCredentialPromise = publicClientCredentialDataSource.get();
