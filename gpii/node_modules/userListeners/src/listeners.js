...
gpii.userListeners.gpiiKeyArrived = function (that, gpiiKey) {
    fluid.log(that.listenerName + " GPII key arrived: " + gpiiKey);
    var loginInfo = {
    ...
    if (that.environmental && that.proximity) {
        ...
        that.lifecycleManager[that.proximity ? "performProximityTriggered" : "performLogin"](gpiiKey, loginInfo);
    }
};
...
gpii.userListeners.gpiiKeyRemoved = function (that, gpiiKey) {
    fluid.log(that.listenerName + " GPII key removed: " + gpiiKey);
