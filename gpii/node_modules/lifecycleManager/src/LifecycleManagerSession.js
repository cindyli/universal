...
(function () {
    ...
    gpii.lifecycleManager.session.savePrefsUpdates = function (that, preferences, transactionSources, onAutoSaveRequired) {
        ...
        if (transactionSources.userUpdate) {
            ...
            if (prefsForAutoSave) {
                ...
                onAutoSaveRequired.fire(that.model.gpiiKey, autoSavePrefs, that.model.clientCredentialType);
            }
        }
    };
    ...
    */
    ...
    gpii.lifecycleManager.computeLocalFetcher = function (session) {
        // let the user's GPII key as well as anything else in the session be resolvable (this latter is
