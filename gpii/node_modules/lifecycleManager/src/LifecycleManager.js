...
(function () {
    ...
    */
    gpii.lifecycleManager.executeSettingsAction = function (that, solutionId, solutionRecord, session, handlerType, settingsHandlerBlockName, rootAction) {
        ...
        return function () {
            fluid.log("=== executeSettingsAction, calling session.localResolver, settingsHandlerBlock: ", settingsHandlerBlock);
            ...
            if (rootAction === "isRunning") { // only run get and return directly if where checking for running applications
                fluid.log("=== executeSettingsAction, calling invokeSettingsHandlerGet, solutionId: ", solutionId);
                fluid.log("=== executeSettingsAction, calling invokeSettingsHandlerGet, expanded: ", expanded);
                return that.invokeSettingsHandlerGet(solutionId, expanded);
            } else {
                fluid.log("=== executeSettingsAction, calling invokeSettingsHandlerSet, solutionId: ", solutionId);
                fluid.log("=== executeSettingsAction, calling invokeSettingsHandlerSet, expanded: ", expanded);
                fluid.log("=== executeSettingsAction, calling invokeSettingsHandlerSet, handlerType: ", handlerType);
                var settingsPromise = that.invokeSettingsHandlerSet(solutionId, expanded, handlerType);

                settingsPromise.then(function (snapshot) {
                    fluid.log("=== executeSettingsAction, returned by invokeSettingsHandlerSet, snapshot: ", snapshot);
    ...
    gpii.lifecycleManager.executeActions = function (that, solutionId, solutionRecord, session, actionBlock, rootAction) {
        ...
        var sequence = fluid.transform(steps, function (action) {
            if (typeof(action) === "string") {
                ...
                return function () {
                    fluid.log("=== executeActions, calling session.localResolver, action is not a string, action: ", action);
