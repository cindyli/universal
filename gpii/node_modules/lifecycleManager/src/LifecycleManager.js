...
(function () {
    ...
    fluid.defaults("gpii.lifecycleManager", {
        ...
        dynamicComponents: {
            userLogonRequests: {
                ...
                options: {
                    gpiiKey: "{arguments}.1",
                    clientCredentialType: "{arguments}.2",
        ...
        invokers: {
            ...
            performProximityTriggered: {
                ...
                args: ["{that}", "{arguments}.0", "{arguments}.1.clientCredentialType"]
                                 // gpiiKey, loginInfo
            },
     ...
     * @param {String} clientCredentialType - The type of client credential used to communicate with the cloud
     * to read/write settings. Can be "local" or "secured".
     * @return {Promise} The promise whose resolved value contains the logon success message and rejected value contains
     * the fail message.
     */
    gpii.lifecycleManager.performProximityTriggered = function (that, gpiiKey, clientCredentialType) {
     ...
     * @property {Boolean} isEnvironmentalLogin - Whether this is an environmental login (windows auto key-in).
     * @property {String} clientCredentialType - The type of client credential used to communicate with the cloud
    ...
    gpii.lifecycleManager.performLogin = function (that, gpiiKey, loginInfo) {
        ...
        var logonPromise = that.addToUserLogonRequestQueue({
            gpiiKey: gpiiKey,
            logonState: "login",
            clientCredentialType: loginInfo.clientCredentialType
        });
        return logonPromise;
    };
    ...
    gpii.lifecycleManager.applyWithNewPrefs = function (that, session, parsedPrefs, prefsAppliedLocalEvent) {
        ...
        var matchMakingPromise = that.privateMatchMaker.doMatch(activeGpiiKey, updatedPrefSet, session.model.clientCredentialType);
    ...
    */
    ...
    gpii.lifecycleManager.processStart = function (that, userSession, finalPayload) {
        ...
        var filteredPayload = fluid.filterKeys(finalPayload, ["gpiiKey", "clientCredentialType", "preferences", "activePrefsSetName", "activeConfiguration", "solutionsRegistryEntries", "matchMakerOutput", "currentPreferences"]);
