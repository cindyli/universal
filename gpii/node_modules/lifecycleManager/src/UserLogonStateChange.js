    ...
    invokers: {
        getSettings: {
            ...
            args: [
                ...
                "@expand:{deviceReporter}.platformReporter.reportPlatform()",
                "{that}.gpiiKey",
...
gpii.lifecycleManager.untrusted.getSettings = function (settingsDataSource, solutionsRegistryDataSource, platform, gpiiKey, deviceReporterData, onMatchDone, onError) {
    ...
    var currentSrVersion = solutionsRegistryDataSource.getCurrentVersion(platform.id);
    var settings = gpiiKey === "noUser" ? fluid.promise().resolve(noUserSettings) : settingsDataSource.get(gpiiKey, deviceReporterData, currentSrVersion);
