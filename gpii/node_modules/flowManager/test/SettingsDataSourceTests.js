...
gpii.tests.settingsDataSource.settingsGetUrl = "/%gpiiKey/settings/%device?srVersion=%srVersion";
gpii.tests.settingsDataSource.settingsPutUrl = "/%gpiiKey/settings";
gpii.tests.settingsDataSource.gpiiKey = "gpii-key-test";
gpii.tests.settingsDataSource.srVersion = 2;
...
fluid.defaults("fluid.tests.settingsDataSource.sequenceElement.get", {
    ...
    sequence: [{
        ...
        args: [gpii.tests.settingsDataSource.gpiiKey, gpii.tests.settingsDataSource.device, gpii.tests.settingsDataSource.srVersion],
