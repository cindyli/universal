...
(function () {
     ...
     * @param {Integer} srVersion - Optional: The requested solution registry version. If not provided, the solution registry
     * of the current version is used.
     ...
     */
    gpii.flowManager.getSolutions = function (solutionsRegistryDataSource, deviceContext, srVersion, onSuccessEvent, onErrorEvent) {
        ...
        promise.then(function (solutions) {
            ...
            var currentSrVersion = solutionsRegistryDataSource.getCurrentVersion(os);
            // Return solutionsRegistryEntries in the requested version
            if (srVersion && currentSrVersion > srVersion) {
                solutionsRegistryEntries = gpii.solutionsRegistry.transformSolutionsBtwVersions(fluid.copy(solutionsRegistryEntries), os, currentSrVersion, srVersion);
            }
    ...
    fluid.defaults("gpii.flowManager.matchMaking", {
        invokers: {
            ...
            getSolutions: {
                ...
                args: [ "{flowManager}.solutionsRegistryDataSource", "{arguments}.0", "{that}.srVersion", "{that}.events.onSolutions", "{that}.events.onError"]
            }
        },
        events: {
        ...
        listeners: {
            ...
            "onGpiiKey.setSrVersion": {
                listener: "fluid.set",
                args: ["{that}", ["srVersion"], "{arguments}.1"]
            },
