 ...
 * @param {String} [clientCredentialType] - [optional] The client credential type to be used for the save.
 ...
 */
gpii.flowManager.local.savePreferences = function (that, gpiiKey, preferences, clientCredentialType) {
    ...
    if (gpiiKey && preferences && gpiiKey !== "noUser") {
        if (that.setSettings) {
            ...
            // to be auto saved.
            var savePromise = that.setSettings(gpiiKey, preferences, clientCredentialType);
