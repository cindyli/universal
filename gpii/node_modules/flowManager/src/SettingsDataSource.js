...
fluid.defaults("gpii.flowManager.settingsDataSource", {
    ...
    settingsGetUrlTemplate: "%cloudURL/%gpiiKey/settings/%device?srVersion=%srVersion",
 ...
 * @param {Object} srVersion - The current encoding version of solution registry.
 * @return {Promise} A promise whose resolved value is the user settings.
 */
gpii.flowManager.settingsDataSource.get = function (that, gpiiKey, device, srVersion) {
