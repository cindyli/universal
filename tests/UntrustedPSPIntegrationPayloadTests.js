...
require("./shared/PSPIntegrationPayloadTestDefs.js");
...
fluid.defaults("gpii.tests.untrusted.pspIntegration.testCaseHolder", {
    gradeNames: [
        "gpii.tests.pspIntegration.testCaseHolder.common.windows"
    ],
    components: {
        rawPrefsAtStart: {
...
gpii.tests.untrusted.pspIntegration.addConfig = function (testDefIn) {
    return fluid.extend(true, {}, testDefIn, {
        config: {
            configName: "gpii.tests.acceptance.windows.builtIn.untrustedPSPIntegration.config",
